		...
		<div class="container">
			...
			<form class="form-horizontal" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="numero de libreta" class="form-control" id="numero_de_libreta" name="numero de libreta" placeholder="numero de libreta" value="<?php echo $row['correo']; ?>"  required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="facu" class="form-control" id="facultad" name="facultad" placeholder="facultad" value="<?php echo $row['facultad']; ?>" >
					</div>
